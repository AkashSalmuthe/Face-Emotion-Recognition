...
classifier =load_model('models//Akash_CNN_model.h5')

# load weights into new model
classifier.load_weights("models//Akash_CNN_model.h5")
...
def main():
    ...
    # st.sidebar.markdown(""">* [Akash Salmuthe] (https://www.linkedin.com/in/akash-salmuthe-17a666214/)
    if choice == "Home":
        ...
        webrtc_streamer(key="example", vvideo_processor_factory=VideoTransformer)
        ...
        html_temp4 = """
                                    ...
                                    <h4 style="color:white;text-align:center;">Akash Salmuthe created this demo application using the Streamlit Framework, OpenCV, Tensorflow, and Keras libraries. </h4>
